...
class ClasificacionInstitucion(models.Model):
    ...
    def __unicode__(self):
        return ' '.join([self.clasificacion_institucion])
...
admin.site.register(ClasificacionInstitucion)
admin.site.register(Instituciones)
admin.site.register(InstitucionesCarreras)
admin.site.register(InstitucionesModalidades)
admin.site.register(InstitucionesNiveles)
